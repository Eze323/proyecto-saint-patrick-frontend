<template>
    <div class="card bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
      <!-- Header -->
      ...
      <div class="card-footer p-4 border-t border-gray-200">
        <div class="button-group flex flex-col sm:flex-row gap-2">
          <button
            @click="handleAction"
            class="card-action-button flex items-center justify-center gap-2 p-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors"
          >
