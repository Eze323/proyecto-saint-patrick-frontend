...
import type { ValidationResponse, TransferResponse, Account } from '../utils/types';
  ...
  actions: {
    ...
    async submitTransfer() {
      ...
      try {
        ...
        this.errorMessage = error.response?.data?.message || 'Error al enviar la transferencia.';
